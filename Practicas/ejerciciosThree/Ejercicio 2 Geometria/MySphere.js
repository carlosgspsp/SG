...
class MySphere extends THREE.Object3D {
    constructor(gui = null,titleGui = null) {
      super();
      ...
      var sphereGeom = new THREE.SphereBufferGeometry (1,64,32, 0, Math.PI*2,0.0, 2.0);
      // Como material se crea uno a partir de un color
     // var sphereMat = new THREE.MeshPhongMaterial({color: 0x00f828});
     //var sphereMat = new THREE.MeshPhongMaterial({color: 0x00f828});
    ...
    update () {
      ...
      this.sphere.rotation.set (this.guiControls.rotX,this.guiControls.rotY,this.guiControls.rotZ);
      //this.scale.set (this.guiControls.sizeX,this.guiControls.sizeY,this.guiControls.sizeZ);
      this.sphere.scale.set (this.guiControls.radius,this.guiControls.radius,this.guiControls.radius);
